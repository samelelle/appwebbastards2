  ...
  async function handleShowDelibera(meetingId) {
    ...
    try {
      ...
      if (Array.isArray(data) && data.length > 0) {
        ...
        setCurrentDeliberaId(data[0].id || null);
      } else {
          ...
          <div style={{ background: '#222', color: '#fff', borderRadius: '16px', padding: isMobile ? '22px' : '32px', width: 'min(92vw, 370px)', maxWidth: '92vw', boxShadow: '0 4px 24px #000a', position: 'relative', boxSizing: 'border-box', maxHeight: '80vh', overflowY: 'auto', overflowX: 'hidden' }}>
            ...
            {deliberaViewLoading ? (
              ...
              <>
                ...
                <textarea value={editDeliberaText} onChange={e => setEditDeliberaText(e.target.value)} style={{ width: '100%', minHeight: '90px', borderRadius: '8px', padding: '10px', fontSize: '1em', background: '#111', color: '#fff', border: '1px solid #555', marginBottom: '18px', boxSizing: 'border-box' }} />
      ...
      {detailMeeting && (
        <div
          style={{
            ...
            alignItems: 'center',
            justifyContent: 'center',
            zIndex: 9001, // sopra la bottom nav
          }}
        >
          <div style={{ background: '#222', color: '#fff', borderRadius: '16px', padding: '32px', width: 'min(90vw, 360px)', maxWidth: '90vw', boxShadow: '0 4px 24px #000a', position: 'relative', boxSizing: 'border-box', maxHeight: '80vh', overflowY: 'auto', overflowX: 'hidden', paddingBottom: 'calc(32px + var(--bb-mobile-bottom-nav-height, 94px))' }}>
